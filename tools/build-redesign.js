...
#hero-ghost .gl-floor i {
  ...
  background:linear-gradient(180deg,
    transparent 0%,
    color-mix(in srgb,var(--tap) 4%,transparent) 55%,
    color-mix(in srgb,var(--tap) 10%,transparent) 100%);
  border:1px solid color-mix(in srgb,var(--tap) 7%,transparent);
  border-bottom:none;
}
#hero-ghost .gl-floor i:nth-child(2n) {
  background:linear-gradient(180deg,
    transparent 0%,
    color-mix(in srgb,var(--dtap) 4%,transparent) 55%,
    color-mix(in srgb,var(--dtap) 9%,transparent) 100%);
  border-color:color-mix(in srgb,var(--dtap) 6%,transparent);
}
